    ...
    <div class="accordion border-0" id="loanAccordion">
        @forelse($loans as $loan)
            <div class="accordion-item mb-3 shadow-sm loan-card"
                    ...
                    <div class="accordion-button collapsed py-3 px-4 bg-white" type="button" data-bs-toggle="collapse"
                        ...
                        <div class="row w-100 align-items-center g-3">
                            ...
                            <div class="col-12 col-md-5">
                                <div
                                    class="d-flex align-items-center justify-content-between justify-content-md-end gap-2 me-md-3">
                                    <form action="{{ route('loans.update-global-status', $loan->id) }}" method="POST"
                                        class="d-flex align-items-center form-update-status"
                                        onclick="event.stopPropagation();">
                                        @csrf
                                        <div
                                            class="btn-group btn-group-sm shadow-sm me-2 border rounded-pill overflow-hidden">
                                        ...
                                        <button type="submit"
                                            class="btn btn-dark btn-sm px-3 rounded-pill shadow-sm">Update</button>
                                    </form>
                                    @can('administrator')
                                        <button type="button"
                                            class="btn btn-outline-danger btn-sm rounded-circle delete-loan-btn"
                ...
                <div id="collapse{{ $loan->id }}" class="accordion-collapse collapse" data-bs-parent="#loanAccordion">
